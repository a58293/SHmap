...
完整的地块或对象描述。`;
  ...
  function workspaceSnapshot(){return {
    ...
    workspaceUi:state.workspaceUi,relationDepth:state.relationDepth,relationDisplayMode:state.relationDisplayMode,relationBundleMode:state.relationBundleMode,objectFocusMode:state.objectFocusMode,presentationMode:state.presentationMode,navigationHistory:state.navigationHistory,navigationIndex:state.navigationIndex,researchBookmarks:state.researchBookmarks,undoStack:(state.undoStack||[]).slice(-40),redoStack:(state.redoStack||[]).slice(-40)
  ...
  window.__SHJ_APP_RUNTIME_INFO__={version:"0.6.0",renderArchitecture:"single-static-runtime",relationRendering:"bundled-compact-offscreen-aggregation",bootGuard:true};
  setupV027State();
  init();
  setupV027Features();
  setupV029Features();
