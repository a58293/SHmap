...
assert.equal(tauri.version,"0.7.7");
assert.equal(version.semver,"0.7.7");
assert.ok(read("index.html").includes("DESKTOP v007 · 0.7.7"));
assert.ok(read("dist/index.html").includes("DESKTOP v007 · 0.7.7"));
