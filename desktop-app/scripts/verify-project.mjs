...
if(!indexHtml.includes('id="layerEmpty" />')||!app.includes("uiSchemaVersion:44")||!app.includes('message:"已点击地图空白区域"')||!app.includes('message:"已通过右键退出地块聚焦"')){console.error("v0.4.4空白地块默认关闭或聚焦退出逻辑缺失");failed=true}
