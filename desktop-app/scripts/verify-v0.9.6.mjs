...
const checks = [
["package 版本", pkg.version === "1.0.5"],
["Tauri 版本", tauri.version === "1.0.5"],
["VERSION 版本", version.semver === "1.0.5" && version.app_version === "v010"],
["界面版本", html.includes("DESKTOP v010 · 1.0.5")],
  ...
  ["本轮修改整轮撤销", app.includes("function v050DiscardRoundChanges") && app.includes('id="v050DiscardRound"') && app.includes("[...state.changes].reverse()")],
  ...
  ["备注字段不生成卡片", app.includes("function legacyDossierFieldCard") && app.includes('"备注":"notes"') && (app.includes('["备注",entry.notes]') || app.includes('identityDrawerFieldHTML("备注",entry.notes'))],
...
console.log("v0.9.6 专项校验通过：对象角色分层、博物志详情、九段式导入、数据库启动恢复与原有地图功能均保留。");
