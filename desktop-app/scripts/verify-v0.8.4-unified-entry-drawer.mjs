...
for(const path of ["public/app/app.js","dist/app/app.js"]){
  ...
  assert.ok(objectDrawer.includes('${sections||`<div class="dossier-empty">该对象尚未录入更多资料。</div>`}${topicStrip}'));
  assert.ok(entryDrawer.includes('${sections||`<div class="dossier-empty">该条目尚未录入更多资料。</div>`}${topicStrip}'));
}
console.log("v0.8.4 详情顺序校验通过：独立对象与内部条目均先显示详细资料，再显示本格资料主题。");
