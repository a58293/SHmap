...
const checks=[
  ["detail page uses static category layout",/briefMuseumHTML\(items,\{profile,layout:"static",showEmpty:false(?:,owner:main)?\}\)/.test(app)],
...
console.log("v0.7.6 museum detail layout verification passed.");
