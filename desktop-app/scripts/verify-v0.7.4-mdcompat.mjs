...
function sectionHeader(line) {
  ...
  return (aliases[number] || []).some(alias => title === alias || (number === 6 && title.startsWith(alias))) ? number : null;
}
...
const checks = [
  ["package 版本", pkg.version === "0.7.4"],
  ["Tauri 版本", tauri.version === "0.7.4"],
  ["VERSION 版本", version.semver === "0.7.4" && version.app_version === "v007"],
  ["界面版本", html.includes("DESKTOP v007 · 0.7.4")],
...
console.log(`v0.7.4 Markdown兼容专项校验通过：苍梧之丘样例识别 ${parsed.entries.length} 个有效条目、${fieldCount} 个详情字段。`);
