...
const checks=[
  [notes.startsWith("# 山海经原典地图研究台 v0.9.8"),"更新说明标题不是 v0.9.8"],
  [notes.includes("主题多图图库")&&notes.includes("第06节内部条目"),"更新说明缺少本版核心功能"],
...
console.log("v0.9.8 update notes verification passed");
