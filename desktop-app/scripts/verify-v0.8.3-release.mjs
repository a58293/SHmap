...
assert.equal(tauri.version,"0.8.3");
assert.equal(version.semver,"0.8.3");
assert.ok(read("index.html").includes("DESKTOP v008 · 0.8.3"));
assert.ok(read("dist/index.html").includes("DESKTOP v008 · 0.8.3"));
...
for(const p of ["public/app/app.js","dist/app/app.js"]){
  const s=read(p);
  assert.ok(s.includes('window.__SHJ_APP_RUNTIME_INFO__={version:"0.8.3"'));
