山海经原典地图研究台 Demo v018 · GitHub待处理包下载与应用

【打开方式】
1. 双击“启动山海经地图Demo.bat”。
2. 或直接打开“index.html”。
3. 也可以打开“山海经原典地图研究台_Demo_v018_GitHub待处理包下载与应用_单文件版.html”。
...
简述模式为居中小卡牌；完整模式为全屏博物志。

Markdown v1.1：支持“### 地块档案：X+000_Y+000”更新简要、基础、详细及地块档案。
